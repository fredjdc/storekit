...
@available(watchOS, unavailable)
@available(visionOS, unavailable)
public struct PurchaseIntent : Equatable, Identifiable, Sendable {
...
public struct PurchaseAction {
    ...
    /// - Returns: The result of the purchase
    /// - Throws: A `PurchaseError` or `StoreKitError`.
    public func callAsFunction(_ product: Product, options: Set<Product.PurchaseOption> = []) async throws -> Product.PurchaseResult
}
...
extension EnvironmentValues {
    ...
    ///         }
    ///     }
    public var purchase: PurchaseAction { get }
}
